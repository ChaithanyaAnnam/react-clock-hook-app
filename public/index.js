...
(function () {
	...
	*/
	...
	var store$3 = global$j[SHARED] || setGlobal$1(SHARED, {});
	...
	var uncurryThis$7 = bind && bind.bind(call$3, call$3);
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$4(fn = input.toString) && !isObject$2(val = call$1(fn, input))) return val;
	  if (isCallable$4(fn = input.valueOf) && !isObject$2(val = call$1(fn, input))) return val;
	  if (pref !== 'string' && isCallable$4(fn = input.toString) && !isObject$2(val = call$1(fn, input))) return val;
	...
	var toString$2 = uncurryThis$1({}.toString);
	...
	function Clock(props) {
	  ...
	  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "The current time is ", currentDateTime.toString()));
	}

	ReactDOM.render( /*#__PURE__*/React.createElement(React.StrictMode, null, /*#__PURE__*/React.createElement(Clock, null)), document.getElementById('root'));
